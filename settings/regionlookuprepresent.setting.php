...
return [
  ...
  'regionlookuprepresent_federalriding_nickname' => [
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts("Add the MP name in the federal riding nickname field? (Or the riding name in the MP's nickname field if creating individuals.)"), // FIXME: we also use this to add the photo to the riding's record
    'description' => E::ts("This can help with looking up ridings using the MP's name and vice versa."),
    'help_text' => '',
  ...
  'regionlookuprepresent_federalriding_mp_reltype' => [
    ...
    'description' => E::ts('Relationship type to the MP individual contact record. If empty, individual MPs will not be created.'),
    'help_text' => '',
    'quick_form_type' => 'Select',
    'html_type' => 'Select',
    'html_attributes' => array(
  ...
  'regionlookuprepresent_federalriding_candidate_reltype' => [
    'group_name' => 'domain',
    'group' => 'regionlookuprepresent',
    'name' => 'regionlookuprepresent_federalriding_candidate_reltype',
    'subsection' => 'federalriding',
    'type' => 'Integer',
    'default' => NULL,
    'add' => '1.0',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('Federal candidate relationship type'),
    'description' => E::ts('Relationship type to the candidate individual contact record.'),
    'help_text' => '',
    'quick_form_type' => 'Select',
    'html_type' => 'Select',
    'html_attributes' => array(
...
/* same mp_ctype as federal so that they can easily switch from one to the other
  'regionlookuprepresent_provincialriding_mp_ctype' => [
    'group_name' => 'domain',
    'group' => 'regionlookuprepresent',
    'name' => 'regionlookuprepresent_provincialriding_mp_ctype',
    'subsection' => 'provincialriding',
    'type' => 'Integer',
    'default' => NULL,
    'add' => '1.0',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('Provincial MLA/MNA individual contact type'),
    'description' => E::ts('Assumes that this is a subtype of Individual. If empty, provincial MLA/MNAs will not be synched from Represent.'),
    'help_text' => '',
    'quick_form_type' => 'Select',
    'html_type' => 'Select',
    'html_attributes' => array(
...
*/
  'regionlookuprepresent_provincialriding_mp_reltype' => [
    ...
    'description' => E::ts('Relationship type to the MLA/MNA individual contact record. If empty, individual MLA/MNAs will not be created.'),
    'help_text' => '',
    'quick_form_type' => 'Select',
    'html_type' => 'Select',
    'html_attributes' => array(
  ...
  'regionlookuprepresent_provincialriding_candidate_reltype' => [
    'group_name' => 'domain',
    'group' => 'regionlookuprepresent',
    'name' => 'regionlookuprepresent_provincialriding_candidate_reltype',
    'subsection' => 'provincialriding',
    'type' => 'Integer',
    'default' => NULL,
    'add' => '1.0',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('Provincial candidate relationship type'),
    'description' => E::ts('Relationship type to the candidate individual contact record.'),
    'help_text' => '',
    'quick_form_type' => 'Select',
    'html_type' => 'Select',
  ...
  'regionlookuprepresent_biography_field' => [
    'group_name' => 'domain',
    'group' => 'regionlookuprepresent',
    'name' => 'regionlookuprepresent_biography_field',
    'subsection' => 'ridingsetting',
    'type' => 'Integer',
    'default' => NULL,
    'add' => '1.0',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('Biography Field'),
    'description' => E::ts('Custom field for a biography text. Used for both federal and provincial.'),
    'help_text' => '',
    'quick_form_type' => 'Select',
    'html_type' => 'Select',
    'html_attributes' => array(
